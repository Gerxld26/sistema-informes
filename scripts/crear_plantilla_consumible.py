...
RUTA_SALIDA = RAIZ / "plantillas" / "plantilla_informe_tecnico_consumible.docx"
...
celda(tabla_header.rows[2].cells[2], "{{ asunto_linea1 }}", {0})
...
parrafo("Estado de suministro:", espacio_despues=6)
